...
class SWDSkill:
    ...
    def build_decision_comparison(self, options: Optional[List[Dict]] = None) -> str:
        ...
        Args:
            options: 决策选项列表，每项包含 name, investment, timeline, risk, return 等
    ...
    def visualize_execution_risks(self, context: Optional[Dict] = None) -> str:
        ...
        Args:
            context: 执行上下文，包含 timeline, resources, dependencies 等
    ...
    def generate_decision_framework(self, decision_type: str = "go_no_go") -> str:
        ...
        Example::
            ...
            # 优先级决策
            framework = skill.generate_decision_framework("priority")
        """
        frameworks = {
            "go_no_go": {
                "title": "🎯 Go/No-Go 决策框架",
