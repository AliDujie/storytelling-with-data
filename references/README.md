...
| `03-clutter.md` | 第三课：消除杂乱元素 |
| `04-attention.md` | 第四课：引导受众注意力 |
| `05-designer.md` | 第五课：像设计师一样思考 |
| `06-model-visuals.md` | 第六课：模型可视化 |
| `07-storytelling.md` | 第七课：构建数据叙事 |
| `08-pulling-together.md` | 第八课：整合所有元素 |
